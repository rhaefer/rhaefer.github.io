...
library(pacman)
p_load(gsheet, knitr,raster,leaflet,rsconnect,datasets, tidyverse,  maptools, geojsonio,
...
data_table<-data1 %>% dplyr::select(date, `general area`, tour.name, `nwac avy rating`, weather, duration, `elevation gain (ft)`, `distance (mile)`, photos )
