...
shapefile <- readOGR(dsn=".", layer="ski_tours_3_14_17",verbose = FALSE)
...
leaflet(width=900, height=700) %>%
  ...
  addPolylines(data=shapefile, weight=4, color="red",
               popup=paste(sep="<br/>",paste("<b>Tour Name:</b> ",shapefile$name),
                           ...
                           paste("<b>Distance:</b> ",shapefile$Ski.Tour19, "miles"),
                           paste("<b>Elevation Gained:</b> ",shapefile$Ski.Tour18, "feet"),
                          ...
                          # paste("<b>Photos:</b> ",shapefile$Ski.Tour21)),
                           paste0("<a href=", "\"", shapefile$Ski.Tour22, "\"", "target=", "\"","blank", "\"", ">","Photos" ,"</a>")),
