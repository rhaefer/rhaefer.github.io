...
library(pacman)
pacman::p_load(scales,rCharts,knitr,grid, gridExtra,ggthemes,gsheet,RCurl,dplyr, RODBC, ggmap, foreign, maptools, rgdal, ggplot2, devtools, broom, sp, maps, mapdata, googlesheets)
