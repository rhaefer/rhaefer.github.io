...
library(pacman)
pacman::p_load(knitr,grid, gridExtra,ggthemes,gsheet,RCurl,dplyr, xlsx, RODBC, ggmap, foreign, maptools, rgdal, ggplot2, devtools, broom, sp, maps, mapdata, googlesheets)
...
colnames(data_final)<- c("Population", "ID", "Phases", "Awards", "Jurisdiction", "Project Title", "Size")

kable(data_final[1:10, ], caption = "Top Ten Highest Funding Amounts Per Project")
