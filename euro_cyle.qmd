...
<style>
/* Remove any default width limitations */
html, body {
    width: 100% !important;
...
/* Ensure main content sections take up full width */
.main-container, .content, .quarto-page {
    width: 100% !important;
    max-width: 100% !important;
...
/* You can add specific section styles if needed */
section {
    width: 100% !important;
    max-width: 100% !important;
}
...
routes<-bind_rows(st_read("data/routes/Afternoon_Ride.gpx", layer = "tracks") %>%
...
::: {layout-row="2"}
![Surus](photos/IMG_2503.jpg)

![Surus](photos/IMG_2514.jpg)

![Surus](photos/IMG_2517.jpg)
...
::: {}
![Surus](photos/montmartre.jpg) ![Surus](photos/picasso.jpg)![Surus](photos/LV building.jpg) ![Surus](photos/roundabout.jpg)![Surus](photos/van gogh.jpg)
:::
...
::: {}
![Surus](photos/van%20life.jpg) ![Surus](photos/fontaineblu1.jpg) ![Surus](photos/fontaineblu2.jpg) ![Surus](photos/fontaineblu3.jpg) ![Surus](photos/napoleon.jpg) ![Surus](photos/napoleon2)
:::
...
![Surus](photos/annecy2.jpg) ![Surus](photos/annecy3.jpg) ![Surus](photos/annecy4.jpg)
...
::: {layout-nrow="3"}
![Surus](photos/sallanches1.jpg){width=40%}
![Surus](photos/sallanches2.jpg){width=40%} 
![Surus](photos/sallanches3.jpg){width=40%} 
![Surus](photos/sallanches4.jpg){width=40%}
![Surus](photos/sallanches5.jpg){width=40%}
![Surus](photos/sallanches6.jpg){width=40%}
![Surus](photos/sallanches7.jpg){width=40%}
![Surus](photos/chamhike1.jpg){width=40%}
:::
...
#| error: FALSE
#| message: FALSE
routes %>% filter(name=="Overspending in Zermatt!") %>% mapview(lwd = 6,color = "red", map.types = c("OpenStreetMap","Esri.WorldImagery","OpenTopoMap","CartoDB.Positron"), basemaps = "OpenStreetMap")
```
...
#| error: FALSE
#| message: FALSE
routes %>% filter(name== "Day 6: Como to Milano") %>% mapview(lwd = 6,color = "red", map.types = c("OpenStreetMap","Esri.WorldImagery","OpenTopoMap","CartoDB.Positron"), basemaps = "OpenStreetMap")
```
...
#| error: FALSE
#| message: FALSE
routes %>% filter(name=="Back to Firenze")  %>% mapview(lwd = 6,color = "red", map.types = c("OpenStreetMap","Esri.WorldImagery","OpenTopoMap","CartoDB.Positron"), basemaps = "OpenStreetMap")
```
