...
#| error: FALSE
#| message: FALSE
routes %>% filter(name %in% c("Bike box and thrift mission", "Afternoon Ride"))  %>% mapview(lwd = 6,color = "red", map.types = c("OpenStreetMap","Esri.WorldImagery","OpenTopoMap","CartoDB.Positron"), basemaps = "OpenStreetMap")
```
