...
#join datasets
data_final<-left_join(pop, data_sum, by="ID") %>% dplyr::select (X2010.Population, ID, phases.y, psrc_funds, Sponsor.y, Title.y)
...
data_final<-data_final %>% dplyr::select(Population, `Funding Award`, Jurisdiction, `Project Title`, Size)
